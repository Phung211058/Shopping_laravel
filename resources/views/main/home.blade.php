                ...
                <div class="product-card position-relative">
                  ...
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="/details/{{ $product->id }}" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                    </div>
                  </div>
                  <div class="card-detail justify-content-between align-items-baseline pt-3">
                    ...
                    <span class="item-price text-primary">{{ $product->formatted_sale_price }}</span><span class="text-warning">₫</span>
                  </div>
                </div>
              </div>
              @endforeach
